...
| Method                              | Role                                                   |
| ----------------------------------- | ------------------------------------------------------ |
| **Retrieval-Based (TF-IDF / BM25)** | Primary — retrieve best match from EmpatheticDialogues |
...
_Last updated: March 2026 — Generated as AI context document for project assistance_
